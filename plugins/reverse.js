...
export async function run(sock, msg) {
  ...
  // También revisar si es mensaje efímero o view once
  ...
  try {
    ...
    writeStream.on('finish', () => {
      ...
      // Comando ffmpeg para revertir el audio
      exec(`ffmpeg -i "${mediaPath}" -filter_complex "areverse" "${ran}"`, (err) => {
