...
export const command = 'addps2';
const OWNER_IDS = '97027992080542'; // reemplaza por tu número sin @
...
export async function run(sock, msg, args) {
  ...
  if (sender !== OWNER_IDS) {
    await sock.sendMessage(from, { text: '❌ Solo Josefino puede usar este comando.' });
    return;
  }

  if (args.length < 3) {
    await sock.sendMessage(from, { text: 'Uso: .addps2 <nombre> <calidad> <precio>' });
    return;
  }
