...
export const command = 'addps4';
const OWNER_IDS = '+5215538830665'; // reemplaza por tu número sin @
...
export async function run(sock, msg, args) {
  ...
  if (sender !== OWNER_IDS) {
    await sock.sendMessage(from, { text: '❌ Solo Miguelito puede usar este comando.' });
    return;
  }
